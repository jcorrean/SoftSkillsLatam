...
The next Figure shows the estimated centrality for each basic skill in each country. Scientific reasoning (science) proved to be the first basic skill with the highest centrality regardless of the local academic offering available in each country. Together with scientific reasoning (science), the following basic skills join the top five competencies: speaking, active listening, learning strategy, and active learning.
...
To estimate the importance of these basic skills in the academic offering of graduate programs in Latin America, we now switch the attention to a series of exponential random graph models.
