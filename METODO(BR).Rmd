...
Primero, se carga el paquete "readtext" y se lee el directorio "Brazil" para extraer los textos de los documentos PDF. Luego, se elimina la extensión ".pdf" del identificador de cada documento.
...
```{r}
s1 <- data.frame(kwic(Programs, pattern = phrase("pensamento crítico")))
s2 <- data.frame(kwic(Programs, pattern = phrase("solução problemas")))
s3 <- data.frame(kwic(Programs, pattern = "comunicar"))
s4 <- data.frame(kwic(Programs, pattern = "criatividade"))
s5 <- data.frame(kwic(Programs, pattern = "tranqüilidade"))# paciencia
s6 <- data.frame(kwic(Programs, pattern = "criar"))
...
s10 <- data.frame(kwic(Programs, pattern = "comprometer-se"))
s11 <- data.frame(kwic(Programs, pattern = "gerenciar"))
s12 <- data.frame(kwic(Programs, pattern = "refletir"))
s13 <- data.frame(kwic(Programs, pattern = "verificar"))
s14 <- data.frame(kwic(Programs, pattern = "ético"))
s15 <- data.frame(kwic(Programs, pattern = "suportar")) # tolerar
s16 <- data.frame(kwic(Programs, pattern = "discutir")) 
s17 <- data.frame(kwic(Programs, pattern = "conflitos"))
s18 <- data.frame(kwic(Programs, pattern = "negociação")) # negociar
s19 <- data.frame(kwic(Programs, pattern = "entender"))
s20 <- data.frame(kwic(Programs, pattern = "equipes"))
s21 <- data.frame(kwic(Programs, pattern = "planejar"))
s22 <- data.frame(kwic(Programs, pattern = "efetuar"))  # generar
s23 <- data.frame(kwic(Programs, pattern = "empatia"))   
s24 <- data.frame(kwic(Programs, pattern = "compartilhar")) # compartir
s25 <- data.frame(kwic(Programs, pattern = "analisar"))
s26 <- data.frame(kwic(Programs, pattern = "reconhecer"))
s27 <- data.frame(kwic(Programs, pattern = "dirigir"))  # orientar
s28 <- data.frame(kwic(Programs, pattern = "respeito"))
s29 <- data.frame(kwic(Programs, pattern = "incentivar")) # motivar
s30 <- data.frame(kwic(Programs, pattern = "colaborar")) # cooperar
s31 <- data.frame(kwic(Programs, pattern = "fortalecer"))
s32 <- data.frame(kwic(Programs, pattern = "impulsionar")) # impulsar
s33 <- data.frame(kwic(Programs, pattern = "aproximar"))
s34 <- data.frame(kwic(Programs, pattern = "ajudar"))
s35 <- data.frame(kwic(Programs, pattern = "transformar")) # mudar
s36 <- data.frame(kwic(Programs, pattern = "gostar"))  # apreciar
s37 <- data.frame(kwic(Programs, pattern = "conduzir"))
s38 <- data.frame(kwic(Programs, pattern = "fomentar"))
s39 <- data.frame(kwic(Programs, pattern = "interagir"))
s40 <- data.frame(kwic(Programs, pattern = "identificar"))
s41 <- data.frame(kwic(Programs, pattern = "concorrer")) # competir
s42 <- data.frame(kwic(Programs, pattern = "demonstrar")) # manifestar
s43 <- data.frame(kwic(Programs, pattern = "responsável"))
s44 <- data.frame(kwic(Programs, pattern = "avaliar")) # evaluar
s45 <- data.frame(kwic(Programs, pattern = "inovar"))
s46 <- data.frame(kwic(Programs, pattern = "definir")) # decidir
s47 <- data.frame(kwic(Programs, pattern = phrase("tomada decisões")))
s48 <- data.frame(kwic(Programs, pattern = "flexibilidade"))
s49 <- data.frame(kwic(Programs, pattern = "aconselhar")) # persuadir
s50 <- data.frame(kwic(Programs, pattern = "incentivar")) # convencer
