---
title: "Análisis de Habilidades Blandas en Postgrados (Sección Brazil)"
author: "Julian Tejada y Juan C. Correa"
date: "2024-06-07"
...
ggplot(Programas, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3, fill=Programa)) +
  ...
  scale_fill_manual(values=c("Doutorado"="#FCE300", "Mestrado"="#0A3A7E", "Especialização"="#CE1127")) + 
  scale_color_manual(values=c("Doutorado"="black", "Mestrado"="black", "Especialização"="black")) + # Custom text colors
  coord_polar(theta="y") +
  xlim(c(-1, 4)) +
  theme_void() +
...
```{r}
s1 <- data.frame(kwic(Textos, pattern = phrase("pensamiento crítico")))
s2 <- data.frame(kwic(Textos, pattern = phrase("solucionar problemas")))
s3 <- data.frame(kwic(Textos, pattern = "comunicar"))
s4 <- data.frame(kwic(Textos, pattern = "creatividade"))
s5 <- data.frame(kwic(Textos, pattern = "paciência"))
s6 <- data.frame(kwic(Textos, pattern = "criar"))
s7 <- data.frame(kwic(Textos, pattern = "liderar"))
s8 <- data.frame(kwic(Textos, pattern = "resolver"))
s9 <- data.frame(kwic(Textos, pattern = "envolver"))
s10 <- data.frame(kwic(Textos, pattern = "comprometer-se"))
s11 <- data.frame(kwic(Textos, pattern = "gerenciar"))
s12 <- data.frame(kwic(Textos, pattern = "refletir"))
s13 <- data.frame(kwic(Textos, pattern = "verificar"))
s14 <- data.frame(kwic(Textos, pattern = "ético"))
s15 <- data.frame(kwic(Textos, pattern = "tolerar"))
s16 <- data.frame(kwic(Textos, pattern = "discutir"))
s17 <- data.frame(kwic(Textos, pattern = "conflictos"))
s18 <- data.frame(kwic(Textos, pattern = "negociar"))
s19 <- data.frame(kwic(Textos, pattern = "entender"))
s20 <- data.frame(kwic(Textos, pattern = "equipes"))
s21 <- data.frame(kwic(Textos, pattern = "planejar"))
s22 <- data.frame(kwic(Textos, pattern = "acionar"))
s23 <- data.frame(kwic(Textos, pattern = "empatia"))
s24 <- data.frame(kwic(Textos, pattern = "compartilhar"))
s25 <- data.frame(kwic(Textos, pattern = "analisar"))
s26 <- data.frame(kwic(Textos, pattern = "reconhecer"))
s27 <- data.frame(kwic(Textos, pattern = "guia"))
s28 <- data.frame(kwic(Textos, pattern = "respeito"))
s29 <- data.frame(kwic(Textos, pattern = "motivar"))
s30 <- data.frame(kwic(Textos, pattern = "colaborar"))
s31 <- data.frame(kwic(Textos, pattern = "fortalecer"))
s32 <- data.frame(kwic(Textos, pattern = "impulsionar"))
s33 <- data.frame(kwic(Textos, pattern = "acercar"))
s34 <- data.frame(kwic(Textos, pattern = "ajudar"))
s35 <- data.frame(kwic(Textos, pattern = "mudar"))
s36 <- data.frame(kwic(Textos, pattern = "apreciar"))
s37 <- data.frame(kwic(Textos, pattern = "conduzir"))
s38 <- data.frame(kwic(Textos, pattern = "fomentar"))
s39 <- data.frame(kwic(Textos, pattern = "interagir"))
s40 <- data.frame(kwic(Textos, pattern = "identificar"))
s41 <- data.frame(kwic(Textos, pattern = "competir"))
s42 <- data.frame(kwic(Textos, pattern = "manifesto"))
s43 <- data.frame(kwic(Textos, pattern = "responsável"))
s44 <- data.frame(kwic(Textos, pattern = "avaliar"))
s45 <- data.frame(kwic(Textos, pattern = "inovar"))
s46 <- data.frame(kwic(Textos, pattern = "decidir"))
s47 <- data.frame(kwic(Textos, pattern = phrase("Tomar decisões")))
s48 <- data.frame(kwic(Textos, pattern = "flexibilidade"))
s49 <- data.frame(kwic(Textos, pattern = "persua*"))
s50 <- data.frame(kwic(Textos, pattern = "convencer"))
