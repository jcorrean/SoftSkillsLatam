...
# 2. Description of Network Data

## 2.1 Network general characteristics of skills-programs academic offering by country
...
## 2.2. Eigenvector centrality degree distributions for skills and programs
```{r}
